...
\begin{figure}[ht]
  \centering
  \subfigure[RPC com sucesso na execução ]{\includegraphics[width=0.49\textwidth]{imagens/4-rp-falha1.png}
  \label{fig:4-rp-falha2}}
  \subfigure[RPC com falha na execução]{\includegraphics[width=0.49\textwidth]{imagens/4-rp-falha2.png}\label{fig:4-rp-falha2}}
